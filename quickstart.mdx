...
<Steps>
  <Step title="Sign in">
    Go to [coinversa.ai/developers](https://coinversa.ai/developers) and sign in (Privy — email, wallet, or social).
  </Step>
...
You should see global market stats (total traders, total volume, data coverage period). If you get a 401, your key is wrong or inactive. If you get a 429, check the rate-limit headers — see [authentication](/authentication#rate-limits).
