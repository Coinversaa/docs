...
← {"channel":"connected","data":{"tier":"pro","limits":{"connections":5,
    "subscriptions":100,"feeds":["trades","tradesByCoin","tradesByUser"]}}}
```
...
<Columns cols={2}>
  ...
  <Card title="Feeds and the fill object" icon="water" href="/websocket/feeds">
    The firehose, one coin, one wallet — and every field on a fill.
  </Card>
