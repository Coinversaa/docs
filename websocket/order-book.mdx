...
```json
← {"channel":"connected","data":{"tier":"pro","limits":{"connections":5,"subscriptions":100,"feeds":["trades","tradesByCoin","tradesByUser","liquidations","liquidationsByUser","leverageUpdates","leverageUpdatesByUser","l4Book"]}}}
```
