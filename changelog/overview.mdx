...
- **Tier-gated and rate-limited responses are now machine-actionable**: 403s
  ...
  a bare "forbidden".
- The MCP tool surface grew from **83 → 89 tools**; the REST API from **87 →
  94 endpoints**.
...
- The Pulse MCP tool surface grew from **55 → 89 tools** — see the full catalog in [MCP tools](/mcp/tools). The REST API now exposes **94 endpoints**.
