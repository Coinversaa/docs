---
title: "Tool catalog"
description: "All 99 MCP tools by category, with descriptions and required tiers."
---
...
| `builder_retention` | Pro | Monthly new-user retention triangle (orders plane, 12 months) |
| `builder_overlap` | Pro | The other builders a builder's users also trade through |
| `trader_builders` | Starter | Every builder one wallet trades through, by fees paid |
