---
title: "Introduction"
description: "94 endpoints under /api/public/v1, auto-generated from the live Coinversa OpenAPI spec."
---

The Coinversa Pulse REST API exposes everything the MCP server uses — 94 endpoints covering trader analytics, market data, live risk, HIP-4 outcomes, and the cross-market asset registry.
