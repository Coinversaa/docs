...
| Closed positions | `/pulse/trader/{address}/closed-positions`, `/pulse/trader/{address}/closed-positions/stats` |
...
The `since` parameter accepts a number + unit (`m`, `h`, `d`, `w`). Maximum window is tier-gated — see [Tier matrix](/api-reference/tiers).
