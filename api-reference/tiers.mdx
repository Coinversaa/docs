...
Every [builder analytics endpoint](/api-reference/builders) has a **pay-per-call twin** — no API key, no subscription. The twin lives at the same path under the `/x402` prefix:
